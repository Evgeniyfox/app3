...
# Явные импорты скрытых зависимостей, чтобы они подтянулись в exe
import pkg_resources
import jaraco.collections
import jaraco.functools

# --- Дополнительно для параллельных вычислений ---
...
#   import cupy as cp
#    gpu_available = True
#    st.sidebar.success("CuPy: GPU доступен")
#except ImportError:
#    gpu_available = False
#    st.sidebar.warning("CuPy не установлен или нет CUDA")


# Инициализация локального кластера Dask (опционально)
#try:
#    client = Client()
#   st.sidebar.success("Dask-кластер запущен")
#except Exception as e:
#    st.sidebar.warning(f"Dask не запущен: {e}")
